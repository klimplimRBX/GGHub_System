...
if PlayerGui:FindFirstChild("GGHub_GAG") then
	PlayerGui.GGHub_GAG:Destroy()
end
...
AppSignature.Text = "GGHub para Grow a Garden - by KlimplimRBX"
...
local createMultiDropdown = components.createMultiDropdown
